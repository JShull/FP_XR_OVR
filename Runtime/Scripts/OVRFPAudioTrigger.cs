...
{
    ///The original code was part of the Oculus Integration Sample Package, I didn't want a dependency to that package so I've made adjustments and copied it here.
    ...
    public class OVRFPAudioTrigger : MonoBehaviour
    {
        [SerializeField]
        ...
        [SerializeField]
        private OVRFPMinMaxPair _volumeRandomization;
        public OVRFPMinMaxPair VolumeRandomization
        {
            get
            {
        ...
        [Tooltip("Check the 'Use Random Range' bool and adjust the min and max slider values for randomized volume level playback.")]
        [SerializeField]
        private OVRFPMinMaxPair _pitchRandomization;
        public OVRFPMinMaxPair PitchRandomization
        {
            get
            {
